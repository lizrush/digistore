...
function program1(depth0,data) {
  ...
  data.buffer.push("<img src=\"/images/kittyimages-50.png\" alt=\"kitty images\" id=\"header-image\"> <p class='lead'><small>Your one stop shop for images of cats.</small></p>");
  }
...
function program1(depth0,data) {
  ...
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("Product name: </li>\n  ");
  return buffer;
  }
